    ...
    <div class="col-md-10 offset-md-1">
      ...
      <p>
        * Montieren und Umbauten von Hallen
        <br />
        * Fertigen und montieren von Industrieanlagen
        <br />
        * Fertigung und Montage von Geländern, Treppen und Laderampen
        <br />
        * Schweißkonstruktionen jeder Art
        <br />
        * Demontage von Hallen und Industrieanlagen
        <br />
...
<section class="text-center">
  <div class="container">
    <div class="col-md-10 offset-md-1">
      <h1>Stahl- und Anlagenbau</h1>
      <p>
        Wir bieten folgende Leistungen im Bereich Stahl- und Anlagenbau:
        <br />
        <br />
        * Detail-Engineering
        <br />
...
<section class="text-center">
  <div class="container">
    <div class="col-md-6 offset-md-3">
      <h1>Reparatur und Modernisierung von Br&uuml;cken</h1>
      <p>
        * Strassenbr&uuml;cken
        <br />
        * Eisenbahnbr&uuml;cken
        <br />
        * Versorgungsbr&uuml;cken
        <br />
        * Fu&szlig;g&auml;ngerbr&uuml;cken
        <br />
        * &Uuml;berg&auml;nge
        <br />
        * Fertigung von Br&uuml;ckenteilen
        <br />
      </p>
    </div>
    <div class="d-flex justify-content-around flex-wrap">
  ...
  <div class="container">
    <div class="col-lg-6 offset-lg-3 col-md-10 offset-md-1">
      ...
      <p>
        ...
        * Drehb&auml;nke
        <br />
        * CNC – Fr&auml;smaschinen
        <br />
        * Nutensto&szlig;maschine
        <br />
    ...
    <div class="col-lg-12">
      ...
      <p>
        ...
        * Einbau und Komplettieren von Lukendeckeln
        <br />
        * Reparatur von und an Lukendeckeln
        <br />
        * Fertigung und Einbau von Komponenten (Tanks, Beh&auml;lter, Anlagen)
        <br />
        * Reparatur von Rohrleitungen und Anlagen
        <br />
        * &Uuml;berholung von Anlagenkomponenten
        <br />
        * Stahl- und Schwei&szlig;arbeiten
        <br />
        * Anfertigung von Ersatzteilen (mechanische Bearbeitung)
      </p>
    </div>
    <div class="d-flex justify-content-around flex-wrap">
